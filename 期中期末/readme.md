...
期末
---
Travelling_salesma proble 業務員旅行問題
原本程式是用for迴圈進行貪婪，每次都選擇最近的城市，到達後就把跟前個城市有關的路徑設成INF==999，並把目前腳下踩的地方(0)設成INF然後搜索和腳下城市相連的其他城市的最短路徑。
改進程式把for迴圈的地方用地回替代掉縮簡了兩行程式碼
```python
#參考書範例
# ch15_4.py
